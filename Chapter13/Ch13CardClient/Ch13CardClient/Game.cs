        ...
        public int PlayGame()
        {
            ...
            do
            {
                for (currentPlayer = 0; currentPlayer < players.Length; currentPlayer++)
                {
                    ...
                    // Promt player to pick up card on table or draw a new one.
                    bool inputOk = false;
                    do
                    {
                        ...
                        if (input.ToLower() == "t")
                        {
                            ...
                            // Remove from discardd cards if possible (if deck is reshuffled it won't be there any more)
                        ...
                        if (input.ToLower() == "d")
                        {
                            ...
                            do
                            {
                                ...
                                // Check if card is in discarded pile
                    ...
                    // Promt player for a card to discard.
                    inputOk = false;
                    int choice = -1;
                    do
                    {
                        ...
                        try
                        {
                            //Atempt to convert input into a valid card number.
                    ...
                    // then remove cards from player had and add to discarded card pile.
