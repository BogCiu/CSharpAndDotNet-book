...
namespace Ch20Ex05Client
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            IAppControlService client = ChannelFactory<IAppControlService>.CreateChannel(new NetTcpBinding(), new EndpointAddress("net.tcp://localhost:8081/AppControlService"));
